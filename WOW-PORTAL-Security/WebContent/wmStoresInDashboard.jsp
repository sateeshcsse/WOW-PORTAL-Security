			...
			$.ajax({ url: "getR8SIDetails.do",
		        ...
		        success: function(data){
		           ...
		           for(var i=0;i<keys.length;i++){
		        	   ...
		        	   var temp=2;		        	   
		        	   if(trVal=='SONO'||trVal=='PONO'||trVal=='SLSQ'||trVal=='IPCF'||trVal=='RPromo'){
		        	   ...
		        	   var temp=2;		        	   
		        	   if(trVal=='Tranites'||trVal=='SIN'||trVal=='TFSF'||trVal=='LT_PR'){
		        		   for(var j=0;j<tdVals.length;j++){ 	
		        			   if(j!=4){
		        				   if(j!=5){
		        					   var value = tdVals[j];
...
<div id="content">
	...
	<div class="pageName">
        	        <label>R8 Stores Inbound Messages</label>
                </div>
	<div class="col-sm-12 col-md-12 col-lg-12 generationArea" id="generationArea" style="padding-bottom: 50px; margin-left: 0.5%;">
							...
							<col width='8%'>
								    <thead>
								      <tr class="TestingPart">
								        <th>MESSAGE TYPE</th>
								        <th>INTEGRATION SERVER</th>
								        <th>BROKER STATUS</th>
								        <th>BROKER UTILIZATION</th>
								        <th>JMS TRIGGER</th>
								        <th>JMS BROKER UTILIZATION</th>
								        <th>JDBC STATUS</th>
								    ...
								    <tbody>							
								    	...
								    	<tr class="SLSQ" >
								    		<td id="blueBackground">SOH Pullback request</td>
								    		<td></td>
								    		<td></td>
								    		<td></td>
								    		<td></td>
								    	...
								    	<tr class="RPromo" >
								    		<td id="blueBackground">R10Promo</td>
								    		<td></td>
								    		<td></td>
								    		<td></td>
								    		<td></td>
				...
				<div class="pageName">
        	        <label>R8 Stores Inbound Files</label>
                </div>
							...
							<col width='20%'>
								    <thead>
								      <tr class="TestingPart">
								        ...
								        <th>RTP IS</th>
								        <th>RTP SCHEDULAR</th>
								        <th>RTP DISC SPACE</th>
								        <th>LAST UPDATED ON</th>								        
								      </tr>
								    </thead>
								    <tbody>							
								    	<tr class="Tranites" >
								    		<td id="blueBackground">Tranites</td>
								    		<td></td>
								    		<td></td>
								    		<td></td>
								    		<td></td>
