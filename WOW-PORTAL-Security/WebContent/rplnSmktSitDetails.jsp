...
<title>SMKT/PEL/LIQUOR SIT Replenishment Dashboard</title> 
...
<div id="content">
	...
	<div class="pageName">
        	        <label>SMKT/PEL/LIQUOR SIT JOB STATUS</label>
                </div>
	<div class="col-sm-12 col-md-12 col-lg-12 generationArea" id="generationArea" style="padding-bottom: 50px; padding-right: 400px; padding-left: 400px">
							...
							<col width='10%'>
								    ...
								    <tbody>							
								    	<tr class="OrderuptoStream" >
								    		<td id="blueBackground">Order up to Stream</td>
								    		<td></td>
								    		<td></td>
								    		<td></td>
								    	</tr>	
								    	<tr class="ProfileLoading" >
								    		<td id="blueBackground">Profile Loading</td>
								    		<td></td>
								    		<td></td>
								    		<td></td>
								    	</tr>	
								    	<tr class="MPLstream" >
								    		<td id="blueBackground">MPL stream</td>
								    		<td></td>
								    		<td></td>
								    		<td></td>
								    	</tr>			
								    	...
								    	<tr class="ForecasttransferfromDMtoRP" >
								    		<td id="blueBackground">Forecast transfer from DM to RP</td>
								    		<td></td>
								    		<td></td>
								    		<td></td>
								    	</tr>
								    	<tr class="InventoryDetailsProcess" >
								    		<td id="blueBackground">Inventory Details Process</td>
								    		<td></td>
								    		<td></td>
								    		<td></td>
								    	</tr>
								    	<tr class="BRPSUGOgenerationSprint" >
								    		<td id="blueBackground">BRP SUGO generation (Sprint)</td>
								    		<td></td>
								    		<td></td>
								    		<td></td>
								    	</tr>
								    	<tr class="BRPMarathon" >
								    		<td id="blueBackground">BRP (Marathon)</td>
								    		<td></td>
								    		<td></td>
								    		<td></td>							    		
								    	</tr>
								    	<tr class="SamedayTPRP" >
								    		<td id="blueBackground">Same day TPRP</td>
								    		<td></td>
								    		<td></td>
								    		<td></td>
								    	</tr>								    	
								    	<tr class="FFUIavailability" >
								    		<td id="blueBackground">FF UI availability</td>
								    		<td></td>
								    		<td></td>
								    		<td></td>							    		
								    	</tr>
								    	<tr class="JOBPDMUIAU" >
								    		<td id="blueBackground">JOB PDM UI AU</td>
								    		<td></td>
								    		<td></td>
								    		<td></td>
								    	</tr>
								    	<tr class="JOBPDMUINZ" >
								    		<td id="blueBackground">JOB PDM UI NZ</td>
								    		<td></td>
								    		<td></td>
								    		<td></td>
								    	</tr>
								    	<tr class="JOBSDMUIAU" >
								    		<td id="blueBackground">JOB SDM UI AU</td>
								    		<td></td>
								    		<td></td>
								    		<td></td>
								    	</tr>
								    	<tr class="JOBSDMUINZ" >
								    		<td id="blueBackground">JOB SDM UI NZ</td>
								    		<td></td>
								    		<td></td>
								    		<td></td>
								    	</tr>
				...
				<div class="pageName">
        	        <label>SMKT/PEL/LIQUOR SIT UI STATUS</label>
                </div>
                	...
                	<div class="col-sm-12 col-md-12 col-lg-12 generationArea" id="generationArea" style="padding-bottom: 50px; padding-right: 700px; padding-left: 700px">
							...
							<col width='10%'>
								    ...
								    <tbody>	
								    <tr class="SDMAU" >
								    		<td id="blueBackground">SDM AU</td>
								    		<td></td>
								    	</tr>
								    	<tr class="PDMAU" >
								    		<td id="blueBackground">PDM AU</td>
								    		<td></td>
								    	</tr>
								    	<tr class="PDMNZ" >
								    		<td id="blueBackground">PDM NZ</td>
								    		<td></td>
								    	</tr>
								    	<tr class="SDMNZ" >
								    		<td id="blueBackground">SDM NZ</td>
								    		<td></td>
								    	</tr>
								    </tbody>
								  </table>
