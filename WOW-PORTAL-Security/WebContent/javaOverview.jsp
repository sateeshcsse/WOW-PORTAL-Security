...
<title>Java Applications Dashboard</title> 
...
<div id="content">
	...
	<div class="pageName">
        	        <label>Java UAT Dashboard</label>
                </div>
	<div class="col-sm-12 col-md-12 col-lg-12 generationArea" id="generationArea" style="padding-bottom: 50px; padding-right: 600px; padding-left: 600px">
