...
<title>WebMethods Dashboard</title> 
			...
			$.ajax({ url: "getR8SODetails.do",
		        ...
		        success: function(data){
		           ...
		           for(var i=0;i<keys.length;i++){
		        	   ...
		        	   var temp=2;		        	   
		        	   if(trVal=='DSOR'||trVal=='DPOR'||trVal=='WREC'||trVal=='DREC'||trVal=='SEOD'||trVal=='SLSY'||trVal=='PACF'||trVal=='TFMF'){
		        		   for(var j=0;j<=tdVals.length;j++){ 	
		        			   if(j!=7){
		        				   if(j!=8){
					        		   ...
					        		   else if(value=='PARTIALLY FINE')
					        			   $('table .'+trVal+' td:nth-child('+temp+')').css("background","#f78f39");	
					        		   if(j==2){
				        				   if(tdVals[j]>85)
				        					   $('table .'+trVal+' td:nth-child('+temp+')').css("background","#FF4D4D");
				        				   else if(tdVals[j]=='ERROR')
				        					   $('table .'+trVal+' td:nth-child('+temp+')').css("background","#FF4D4D");
				        				   else
				        					   $('table .'+trVal+' td:nth-child('+temp+')').css("background","#3f9f3f");		        				   
				        			   }
		        	   ...
		        	   var temp=2;		        	   
		        	   if(trVal=='TRANTEXT'||trVal=='CEFT'||trVal=='POSDM'||trVal=='PRCE'||trVal=='RST'||trVal=='DLY_SLS'||trVal=='DLY_CUST'){
		        		   for(var j=0;j<tdVals.length;j++){ 	
		        			   if(j!=3){
		        				   if(j!=5){
		        					   if(j!=6){
...
<div id="content">
	...
	<div class="pageName">
        	        <label>R8 Stores Outbound Messages</label>
                </div>
	<div class="col-sm-12 col-md-12 col-lg-12 generationArea" id="generationArea" style="padding-bottom: 50px; margin-left: 0.5%;">
							...
							<col width='8%'>
								    <thead>
								      <tr class="TestingPart">
								        <th>MESSAGE TYPE</th>
								        <th>BROKER CONNECTIVITY</th>
								        <th>SM MESSAGE IS</th>
								        <th>BROKER UTILIZATION (PKGSMCTRBKAC1:8849)</th>
								        <th>JMS BROKER UTILIZATION (PKGSMJMSBKAC1:8863)</th>
								        <th>TRIGGERS</th>
								        <th>JMS BROKER</th>
								        <th>JMS QUEUE LENGTH</th>
								        <th>LAST UPDATED ON</th>								        
								      </tr>
								    </thead>
								    <tbody>							
								    	<tr class="DSOR" >
								    		<td id="blueBackground">DSOR</td>
								    		<td></td>
								    		<td></td>
								    		<td></td>
								    		<td></td>
								    	...
								    	<tr class="SEOD" >
								    		<td id="blueBackground">SEOD (End of day sales)</td>
								    		<td></td>
								    		<td></td>
								    		<td></td>
								    		<td></td>
								    	...
								    	<tr class="SLSY" >
								    		<td id="blueBackground">SOH Pullback response</td>
								    		<td></td>
								    		<td></td>
								    		<td></td>
								    		<td></td>
				...
				<div class="pageName">
        	        <label>R8 Stores Outbound Files</label>
                </div>
							...
							<col width='10%'>
								    <thead>
								      <tr class="TestingPart">
								        ...
								        <th>TRIGGERS</th>
								        <th>SCHEDULAR</th>
								        <th>DISC SPACE UTILIZATION</th>
								        <th>LAST UPDATED ON</th>								        
								      </tr>
								    </thead>
								    <tbody>							
								    	<tr class="TRANTEXT" >
								    		<td id="blueBackground">Daily Electronic Journal Trantext(EJ)</td>
								    		<td></td>
								    		<td></td>
								    		<td></td>
								    		<td></td>
								    	...
								    	<tr class="CEFT" >
								    		<td id="blueBackground">Centralised EFT File from Store (CEFT)</td>
								    		<td></td>
								    		<td></td>
								    		<td></td>
								    		<td></td>
								    	...
								    	<tr class="POSDM" >
								    		<td id="blueBackground">Sales (POSDM)</td>
								    		<td></td>
								    		<td></td>
								    		<td></td>
								    		<td></td>
								    	...
								    	<tr class="DLY_SLS" >
								    		<td id="blueBackground">Daily sales to TM1- (DLY_SLS_Flash)</td>
								    		<td></td>
								    		<td></td>
								    		<td></td>
								    		<td></td>
								    	...
								    	<tr class="DLY_CUST" >
								    		<td id="blueBackground">Daily sales to TM1 (DLY_CUST_Count)</td>
								    		<td></td>
								    		<td></td>
								    		<td></td>
								    		<td></td>
