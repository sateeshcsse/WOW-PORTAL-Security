...
<title>SMKT/PEL/LIQUOR UAT Replenishment Dashboard</title> 
...
<div id="content">
	...
	<div class="pageName">
        	        <label>SMKT/PEL/LIQUOR UAT JOB STATUS</label>
                </div>
	<div class="col-sm-12 col-md-12 col-lg-12 generationArea" id="generationArea" style="padding-bottom: 50px; padding-right: 400px; padding-left: 400px">
				...
				<div class="pageName">
        	        <label>SMKT/PEL/LIQUOR UAT UI STATUS</label>
                </div>
