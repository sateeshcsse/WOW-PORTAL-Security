...
.controller('AppCtrl', function($scope,$http) {
  ...
  $scope.getResource=function(){
	...
	$scope.init=function(){
		...
		$http({
		//	url:'getWMStoresStatus.do', // remove below line and uncomment this after fix
			url:'getWMDivByType.do',
			type:'get',
			params:{'environment': 'UAT','wmType':'R8','division':'SMKT'}, // added for testing. Remove it after fix
// params:{'store': '1712','environment':'UAT'}, // added for testing. Remove it after fix
...
<div id="content">
	<div class="workArea">
		<div class="col-sm-12 col-md-12 col-lg-12">
				<div class="pageName">
        	        <label>WEBMETHODS R8 STORES DASHBOARD - UAT</label>
                </div>
				<div class="row">
				<div class="col-sm-12 col-md-12 col-lg-12">
      				<div class="col-sm-4 col-md-4 col-lg-4" ng-controller="AppCtrl" ng-init="init()">
        				<div class="chart-wrapper" style = "margin-left: -3%;">
          					<div class="chart-title">
            					<label>STORES STATUS</label><div id="trapezoid" class="trapezoid"></div>
          					</div>
          					<div class="chart-stage" id="chart-stage">
            					...
            					<div class="col-sm-12 col-md-12 col-lg-12"  style="margin-top: 2%;">
            						<label class="chart-innerTextWithTargetText">{{offshoreLeveragePercent}}%<BR>FINE</label>
              						<canvas id="doughnut" class="chart chart-doughnut" width="70" height="40" click="getResource"
  										chart-colours = ["#3f9f3f","#FF4D4D"] chart-options= options chart-data="dataOffshoreLeverage" chart-labels="labelsOffshoreLeverage">
									</canvas>
									</div>
            					</div>
					...
					<div class="col-sm-4 col-md-4 col-lg-4" ng-controller="currentEngageMent" ng-init="init()">
        				<div class="chart-wrapper" style = "margin-left: -3%;">
          					<div class="chart-title">
            					<label>STORES OUTBOUND</label><div id="trapezoid" class="trapezoid"></div>
          					</div>
          					<div class="chart-stage" id="chart-stage1">
            					<div id="grid-1-1" class="col-sm-12 col-md-12 col-lg-12">
            					<div class="col-sm-12 col-md-12 col-lg-12"  style="margin-top: 2%;">
            						<label class="chart-innerTextWithTargetText">{{totalNoOfProjects}}%<BR>FINE</label>
              						<canvas id="doughnut" class="chart chart-doughnut" width="70" height="40" click="getDSR"
  										chart-colours = ["#3f9f3f","#FF4D4D"] chart-options="{ percentageInnerCutout: 70 }" chart-data="totalStatusProjects" chart-labels="totalStatusProjectsLabels">
									</canvas>
									</div>
            					</div>
          					</div>	
			    ...
			    <div class="col-sm-4 col-md-4 col-lg-4" ng-controller="storesInboundR8Overview" ng-init="init()">
        				<div class="chart-wrapper" style = "margin-left: -3%;">
          					<div class="chart-title">
            					<label>STORES INBOUND</label><div id="trapezoid" class="trapezoid"></div>
          					</div>
          					<div class="chart-stage" id="chart-stage">
            					<div id="grid-1-1" class="col-sm-12 col-md-12 col-lg-12">
            					<div class="col-sm-12 col-md-12 col-lg-12"  style="margin-top: 2%;">
            						<label class="chart-innerTextWithTargetText">{{SIR8OverviewCenter}}%<BR>FINE</label>
              						<canvas id="doughnut" class="chart chart-doughnut" width="70" height="40" click="goR8SIDetails"
  										chart-colours = ["#3f9f3f","#FF4D4D"] chart-options="{ percentageInnerCutout: 70 }" chart-data="SIR8OverviewValues" chart-labels="SIR8OverviewLabels">
									</canvas>
									</div>
            					</div>
          					</div>
...
<!-- end of three -->
      			...
      			<div class="col-sm-4 col-md-4 col-lg-4" ng-controller="performanceController" ng-init="init()">
        				<div class="chart-wrapper" style = "margin-left: -3%;">
          					<div class="chart-title">
            					<label> PEL STORES OUTBOUND </label><div id="trapezoid" class="trapezoid"></div>
          					</div>
      				...
      				<div class="col-sm-4 col-md-4 col-lg-4" ng-controller="automationController" ng-init="init()">
        				<div class="chart-wrapper" style="margin-left: -3%;">
          					<div class="chart-title">
            					<label> PEL STORES INBOUND </label><div id="trapezoid" class="trapezoid"></div>
          					</div>
          					<div class="chart-stage">
            					<div id="grid-1-1" class="comingSoon">
              						COMING SOON
