...
SLAMetricsApp.controller('SLAMetricsController',function($scope,$http){
	...
	$scope.setClearDate = function(SLAMetricsValue, value) {
		if(value==0) {
			$( "#reviewedDateTDM" ).datepicker( "option", "disabled", true );
			SLAMetricsValue.tdm_date = "";
		} else {
			$( "#reviewedDateTDM" ).datepicker( "option", "disabled", false);
		}
	}
	
	$scope.setClearDateReviewed = function(SLAMetricsValue, value) {
		if(value==0) {
			$( "#reviewedDate" ).datepicker( "option", "disabled", true );
			SLAMetricsValue.reviewed_date = "";
		} else {
			$( "#reviewedDate" ).datepicker( "option", "disabled", false);
		}
	}
	...
	$scope.finalSubmition = function(SLAMetricsValue) {
		...
		if($scope.scheduleSlippage>=0)
			SLAMetricsValue.scheduleSlippage = +$scope.scheduleSlippage;
		else
			SLAMetricsValue.scheduleSlippage = 0;
		if($scope.SLAMetricsValue.effortSlippage<0)
			$scope.SLAMetricsValue.effortSlippage = 0;
		...
		if(mandatorySuccess===false) {
			...
			if($scope.SLAMetricsValue.reviewed=="0") {
				$scope.SLAMetricsValue.reviewed_date == "";
				SLAMetricsValue.reviewed_date == "";
			}
			if($scope.SLAMetricsValue.tdm=="0") {
				$scope.SLAMetricsValue.tdm_date == "";
				SLAMetricsValue.tdm_date == "";
			}
			$http({
	             method: 'POST',
                       ...
                       <div class="col-sm-12 col-md-12 col-lg-12 projectDetails" id="projectDetails">
					    			...
					    			<tr style="background-color: #F5F5F5;">
								      ...
								      <tr style="background-color: white;">
								      	  	<td> SIT </td>
								      	  	<td><input type="text" id="sit_planned_period_from" class="inputField" ng-disabled="SLAMetricsValue.allow" style="background-color: white;" loaded="{{SLAMetricsValue.sit_planned_period_from}}" ng-model="SLAMetricsValue.sit_planned_period_from" ng-change="calculateSlippage();"/></td>
								      	  	<td><input type="text" id="sit_planned_period_to" class="inputField" ng-disabled="SLAMetricsValue.allow" style="background-color: white;" loaded="{{SLAMetricsValue.sit_planned_period_to}}" ng-model="SLAMetricsValue.sit_planned_period_to" ng-change="calculateSlippage();"/></td>
								      	  	<td><input type="text" id="sit_actual_period_from" class="inputField" ng-disabled="SLAMetricsValue.allow" style="background-color: white;" loaded="{{SLAMetricsValue.sit_actual_period_from}}" ng-model="SLAMetricsValue.sit_actual_period_from" ng-change="calculateSlippage();"/></td>
								      	  	<td><input type="text" id="sit_actual_period_to" class="inputField" ng-disabled="SLAMetricsValue.allow" style="background-color: white;" loaded="{{SLAMetricsValue.sit_actual_period_to}}" ng-model="SLAMetricsValue.sit_actual_period_to" ng-change="calculateSlippage();"/></td>
								    ...
								    <div class="col-sm-12 col-md-12 col-lg-12">
								    		<textarea rows="3" cols="100" maxlength="900" placeholder="Comments:" style="width: 100%; height: 100%; border: 3px solid #ddd;margin-bottom: 1.5%;" ng-disabled="SLAMetricsValue.allow" ng-model="SLAMetricsValue.comments_project_details"></textarea>	
    							</div>
    							...
    							<div class="col-sm-12 col-md-12 col-lg-12 rootCause" id="rootCause">
					    			...
					    			<tr style="background-color: #F5F5F5;">
					    				<td style="color: #8AC759;"> <=10</td>
								      	<td style="color: rgb(255,191,0);">>10<=15</td>
								      	<td style="color: rgb(255,77,77);">>15</td>
					    			</tr>
								      <tr style="background-color: white;">
								      	  	<td> SIT </td>
								    ...
								    <div class="col-sm-12 col-md-12 col-lg-12">
								    		<textarea rows="3" cols="100" maxlength="900" placeholder="Comments:" style="width: 100%; height: 100%; border: 3px solid #ddd;margin-bottom: 1.5%;" ng-disabled="SLAMetricsValue.allow" ng-model="SLAMetricsValue.root_comments"></textarea>	
    							</div>
    							<div class="col-sm-12 col-md-12 col-lg-12 defectCount" id="defectCount">
					    			...
					    			<tr style="background-color: #F5F5F5;">
								      ...
								      <tr style="background-color: white;">
								      	  	...
								      	  	<td><input type="number" ng-disabled="SLAMetricsValue.allow" class="inputField" placeholder="0" min="0" style="background-color: white;" ng-model="SLAMetricsValue.sit_rejected"></td>
								      	  	<td><input type="number" ng-disabled="SLAMetricsValue.allow" class="inputField" placeholder="0" min="0" style="background-color: white;" ng-model="SLAMetricsValue.sit_cancelled"></td>
								      ...
								      <tr style="background-color: #F5F5F5;">
								      	  	...
								      	  	<td><input type="number" ng-disabled="SLAMetricsValue.allow" class="inputField" placeholder="0" min="0" ng-model="SLAMetricsValue.uat_rejected" style="background-color: #F5F5F5;"></td>
								      	  	<td><input type="number" ng-disabled="SLAMetricsValue.allow" class="inputField" placeholder="0" min="0" ng-model="SLAMetricsValue.uat_cancelled" style="background-color: #F5F5F5;"></td>
								      ...
								      <tr style="background-color: white;">
								      	  	...
								      	  	<td><input type="number" ng-disabled="SLAMetricsValue.allow" class="inputField" placeholder="0" min="0" style="background-color: white;" ng-model="SLAMetricsValue.prod_rejected"></td>
								      	  	<td><input type="number" ng-disabled="SLAMetricsValue.allow" class="inputField" placeholder="0" min="0" style="background-color: white;" ng-model="SLAMetricsValue.prod_cancelled"></td>
								    ...
								    <div class="col-sm-12 col-md-12 col-lg-12">
								    		<textarea rows="3" cols="100" maxlength="900" placeholder="Comments:" style="width: 100%; height: 100%; border: 3px solid #ddd; margin-bottom: 1.5%;" ng-disabled="SLAMetricsValue.allow" ng-model="SLAMetricsValue.def_comments"></textarea>	
    							</div>
    							 <div class="col-sm-12 col-md-12 col-lg-12">
    							 ...
    							 <div class="col-sm-3 col-md-3 col-lg-3"><label style="font-size: larger; margin-right: 1%;">Reviewed Metrics with TDM Team?</label></div>
									<div class="col-sm-1 col-md-1 col-lg-1" style="margin-left: -6%;"><input type="radio" name="addUpdateTDM" value="0" checked style="width: 35% ! important;"ng-disabled="SLAMetricsValue.allow" ng-model="SLAMetricsValue.tdm" ng-change="setClearDate(SLAMetricsValue, SLAMetricsValue.tdm)"> NO</div>
  									<div class="col-sm-1 col-md-1 col-lg-1" style="margin-left: -4%;"><input type="radio" name="addUpdateTDM" value="1" style="margin-left: 1%; width: 35% ! important;"ng-disabled="SLAMetricsValue.allow" ng-model="SLAMetricsValue.tdm" ng-change="setClearDate(SLAMetricsValue, SLAMetricsValue.tdm)"> YES</div>
  									<div class="col-sm-2 col-md-2 col-lg-2" style="margin-left: -4%;"><input type="text" id="reviewedDateTDM" datepicker="" loaded="{{SLAMetricsValue.tdm_date}}" ng-disabled="SLAMetricsValue.allow" ng-model="SLAMetricsValue.tdm_date"/></div>
									...
									<div class="col-sm-1 col-md-1 col-lg-1" style="margin-left: -6%;"><input type="radio" name="addUpdate" value="0" checked style="width: 35% ! important;"ng-disabled="SLAMetricsValue.allow" ng-model="SLAMetricsValue.reviewed" ng-change="setClearDateReviewed(SLAMetricsValue, SLAMetricsValue.reviewed)"> NO</div>
  									<div class="col-sm-1 col-md-1 col-lg-1" style="margin-left: -4%;"><input type="radio" name="addUpdate" value="1" style="margin-left: 1%; width: 35% ! important;"ng-disabled="SLAMetricsValue.allow" ng-model="SLAMetricsValue.reviewed" ng-change="setClearDateReviewed(SLAMetricsValue, SLAMetricsValue.reviewed)"> YES</div>
  									<div class="col-sm-2 col-md-2 col-lg-2" style="margin-left: -4%;"><input type="text" id="reviewedDate" datepicker="" loaded="{{SLAMetricsValue.reviewed_date}}" ng-disabled="SLAMetricsValue.allow" ng-model="SLAMetricsValue.reviewed_date"/></div>
    							</div>
    							
    							<div class="col-sm-12 col-md-12 col-lg-12">
								    		<textarea rows="3" cols="100" maxlength="900" placeholder="Project Team Comments:" style="width: 100%; height: 100%; border: 3px solid #ddd;margin-bottom: 1.5%;" ng-disabled="SLAMetricsValue.allow" ng-model="SLAMetricsValue.proj_team_comments"></textarea>	
    							</div>
    							...
    							<div class="col-sm-12 col-md-12 col-lg-12 lessonsLearnt" id="lessonsLearnt">
					    			...
					    			<tbody>
					    			<tr style="background-color: white;">
								        <td><textarea rows="3" cols="100" maxlength="900" placeholder="Comments:" style="width: 100%; height: 100%; margin-bottom: 1.5%; border: none;" ng-disabled="SLAMetricsValue.allow" ng-model="SLAMetricsValue.lesson_learnt"></textarea></td>
					    			</tr>
								   ...
								   <div class="col-sm-12 col-md-12 col-lg-12 bestPractices" id="bestPractices">
					    			...
					    			<tbody>
					    			<tr style="background-color: white;">
								        <td><textarea rows="3" cols="100" maxlength="900" placeholder="Comments:" style="width: 100%; height: 100%; margin-bottom: 1.5%; border: none;" ng-disabled="SLAMetricsValue.allow" ng-model="SLAMetricsValue.best_practices"></textarea></td>
					    			</tr>
